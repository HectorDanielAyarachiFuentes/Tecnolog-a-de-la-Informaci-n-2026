...
window.addEventListener('load', () => {
    playlist.push({ file: { name: 'Mirtha Pérez - La Nave Del Olvido.mp4' }, url: '../../../public/media/Mirtha%20P%C3%A9rez%20-%20La%20Nave%20Del%20Olvido.mp4', duration: 'Unknown', folder: 'Library' });
